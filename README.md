...
## Attribution
This project uses **AI Documents Intelligence** as an open-source foundation.

Original repository: https://github.com/josephadeabah/ai-documents-intelligence

The original MIT License and copyright notices remain preserved. See `LICENSE`, `NOTICE.md`, `CONTRIBUTIONS.md` and `docs/ORIGINAL_README.md`.

## License
The original project is licensed under the MIT License. This portfolio repository does not claim original authorship of the foundation code.
